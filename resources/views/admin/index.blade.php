        ...
        <div class="col-xl-3 col-lg-6">
            <section class="card">
                <div class="twt-feed blue-bg">
                    ...
                    <div class="media">
                        <a href="#">
                            <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="{{ asset('adminLTE/images/admin.jpg') }}">
                        </a>
                        <div class="media-body">
                            <h2 class="text-white display-6">V S</h2>
