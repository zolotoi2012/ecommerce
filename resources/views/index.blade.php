...
<main>
                    ...
                    <div class="row d-flex align-items-center justify-content-between">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-none d-md-block">
                            <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                <img src="{{ asset('assets/img/hero/hero_man.png') }}" alt="">
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6">
                    <div class="single-category mb-30">
                        <div class="category-img">
                            <img src="{{ asset('assets/img/categories/cat1.jpg') }}" alt="">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="single-category mb-30">
                        <div class="category-img text-center">
                            <img src="{{ asset('assets/img/categories/cat2.jpg') }}" alt="">
                            <div class="category-caption">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="single-category mb-30">
                        <div class="category-img">
                            <img src="{{ asset('assets/img/categories/cat3.jpg') }}" alt="">
                            <div class="category-caption">
                                <h2>Man`s Cloth</h2>
                                <span class="best"><a href="#">Best New Deals</a></span>
                                <span class="collection">New Collection</span>
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single-product mb-60">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/categories/product1.png') }}" alt="">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single-product mb-60">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/categories/product2.png') }}" alt="">
                                </div>
                                <div class="product-caption">
                                    <div class="product-ratting">
                                        <i class="far fa-star"></i>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single-product mb-60">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/categories/product3.png') }}" alt="">
                                    <div class="new-product">
                                        <span>New</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single-product mb-60">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/categories/product4.png') }}" alt="">
                                </div>
                                <div class="product-caption">
                                    <div class="product-ratting">
                                        <i class="far fa-star"></i>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single-product mb-60">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/categories/product5.png') }}" alt="">
                                </div>
                                <div class="product-caption">
                                    <div class="product-ratting">
                                        <i class="far fa-star"></i>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single-product mb-60">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/categories/product6.png') }}" alt="">
                                    <div class="new-product">
                                        <span>New</span>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="nav-last" role="tabpanel" aria-labelledby="nav-last-tab">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single-product mb-60">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/categori/product5.png') }}" alt="">
                                </div>
                                <div class="product-caption">
                                    <div class="product-ratting">
                                        <i class="far fa-star"></i>
    ...
    <div class="best-product-area lf-padding" >
        <div class="product-wrapper bg-height" style="background-image: url('../../public/assets/img/categories/card.png')">
            <div class="container position-relative">
                <div class="row justify-content-between align-items-end">
                    <div class="product-man position-absolute  d-none d-lg-block">
                        <img src="{{ asset('assets/img/categories/card-man.png') }}" alt="">
                    </div>
            ...
            <div class="row d-flex justify-content-between align-items-end">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    <div class="best-left-img mb-30 d-none d-sm-block">
                        <img src="{{ asset('assets/img/collection/collection1.png') }}" alt="">
                    </div>
                </div>
                <!-- Mid Img -->
                <div class="col-xl-2 col-lg-2 d-none d-lg-block">
                    <div class="best-mid-img mb-30 ">
                        <img src="{{ asset('assets/img/collection/collection2.png') }}" alt="">
                    </div>
                </div>
                <!-- Riht Caption -->
                    ...
                    <div class="best-right-cap ">
                        <div class="best-single mb-30">
                            ...
                            <div class="single-img">
                                <img src="{{ asset('assets/img/collection/collection3.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="best-right-cap">
                        <div class="best-single mb-30">
                            ...
                            <div class="single-img">
                                <img src="{{ asset('assets/img/collection/collection4.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="best-right-cap">
                        <div class="best-single mb-30">
                            ...
                            <div class="single-img">
                                <img src="{{ asset('assets/img/collection/collection5.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="latest-wrapper lf-padding">
        <div class="latest-area latest-height d-flex align-items-center" data-background="assets/img/collection/latest-offer.png">
            ...
            <!-- man Shape -->
            <div class="man-shape">
                <img src="{{ asset('') }}../public/assets/img/collection/latest-man.png" alt="">
            </div>
        </div>
    </div>
    <!-- Latest Offers End -->
